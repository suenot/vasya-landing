        ...
        sections: [
            {
                ...
                text: "Загружая, устанавливая или используя Vasya.app (\"Приложение\"), вы соглашаетесь с настоящими Условиями использования. Если вы не согласны с этими условиями, не используйте Приложение."
            },
            {
                heading: "2. Описание сервиса",
                text: "Vasya.app — это Telegram-клиент с открытым исходным кодом, который предоставляет:\n\n• Автоматическую расшифровку голосовых сообщений (через Local Whisper или Deepgram)\n• Управление несколькими аккаунтами\n• Расширенные функции конфиденциальности\n• Нативную производительность на десктопе через Rust и Tauri"
            },
            {
                heading: "3. Лицензия открытого кода",
                text: "Vasya.app распространяется под лицензией открытого исходного кода. Исходный код доступен на github.com/suenot/vasya. Вы можете свободно использовать, изменять и распространять программное обеспечение в соответствии с условиями лицензии."
            },
            {
            ...
            },
            {
                ...
                text: "Ни при каких обстоятельствах Vasya.app, его участники или разработчики не несут ответственности за любые косвенные, случайные, особые, штрафные убытки, возникшие в связи с использованием вами Приложения."
            },
            {
                heading: "8. Изменения",
        ...
        <div className={styles.page}>
            <header className={styles.header}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <Link href="/" className={styles.logoTitle}>Vasyapp</Link>
                </div>
